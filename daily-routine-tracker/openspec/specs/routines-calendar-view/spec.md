...
Vista tipo agenda diaria para la página `/routines`, con bloques horarios por rutina, color por categoría, y manejo de rutinas sin horario. Incluye orden por horario en la vista Lista y toggle de vista persistente.
